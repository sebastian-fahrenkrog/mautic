    ...
    <div class="card-header">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right">
                <li>
                    <a  href="<?php echo $view['router']->path('mautic_dashboard_action', ['objectAction' => 'edit', 'objectId' => $widget->getId()]); ?>"
                ...
                <li role="separator" class="divider"></li>
                <li>
                    <a  href="<?php echo $view['router']->path('mautic_dashboard_action', ['objectAction' => 'delete', 'objectId' => $widget->getId()]); ?>"
